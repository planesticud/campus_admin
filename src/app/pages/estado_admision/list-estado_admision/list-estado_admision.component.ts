...
@Component({
  selector: 'ngx-list-estado-admision',
  templateUrl: './list-estado_admision.component.html',
  styleUrls: ['./list-estado_admision.component.scss'],
  })
export class ListEstadoAdmisionComponent implements OnInit {
  uid: number;
  ...
  loadData(): void {
    this.admisionesService.get('estado_admision/?limit=0').subscribe(res => {
      if (res !== null) {
