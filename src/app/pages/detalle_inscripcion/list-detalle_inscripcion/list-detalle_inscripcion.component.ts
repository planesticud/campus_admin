...
@Component({
  ...
  templateUrl: './list-detalle_inscripcion.component.html',
  styleUrls: ['./list-detalle_inscripcion.component.scss'],
})
export class ListDetalleInscripcionComponent implements OnInit {
  Aspirante = [];
  Persona = [];
  contacto = [];
  Telefono = [];
  ...
  public CargarDatosAspirante(): void {
    ...
    this.activatedRoute.params.subscribe( params => {
      ...
      this.inscripcionesService.get(`inscripcion/?query=Id:${params['id']}`)
      .subscribe(res => {
        if (res !== null) {
          ...
          Swal({
            ...
            text: `datos de la inscripcion no obtenidos`,
  ...
  public PropuestaGrado(): void {
    this.inscripcionesService.get(`propuesta/?query=Inscripcion:${this.Aspirante['Id']}`)
    .subscribe(res_prop => {
      if (res_prop !== null) {
