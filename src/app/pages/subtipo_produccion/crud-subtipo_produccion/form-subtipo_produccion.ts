export let FORM_SUBTIPO_PRODUCCION = {
  titulo: 'SubtipoProduccion',
  tipo_formulario: 'mini',
  btn: 'Guardar',
  alertas: true,
  modelo: 'SubtipoProduccion',
  campos: [
    {
      etiqueta: 'input',
    ...
    },
    {
      etiqueta: 'select',
      claseGrid: 'col-lg-6 col-md-6 col-sm-12 col-xs-12',
      nombre: 'TipoProduccionId',
      label_i18n: 'tipo_produccion',
      placeholder_i18n: 'tipo_produccion',
      requerido: true,
      tipo: 'TipoProduccion',
      key: 'Nombre',
      opciones: [],
