...
@Component({
  selector: 'ngx-list-tipo-relacion-organizacion',
  templateUrl: './list-tipo_relacion_organizacion.component.html',
  styleUrls: ['./list-tipo_relacion_organizacion.component.scss'],
  })
export class ListTipoRelacionOrganizacionComponent implements OnInit {
  uid: number;
