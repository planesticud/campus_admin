...
@Component({
  selector: 'ngx-list-estado-civil',
  templateUrl: './list-estado_civil.component.html',
  styleUrls: ['./list-estado_civil.component.scss'],
  })
export class ListEstadoCivilComponent implements OnInit {
  ...
  loadData(): void {
    this.personaService.get('estado_civil/?limit=0').subscribe(res => {
      if (res !== null) {
