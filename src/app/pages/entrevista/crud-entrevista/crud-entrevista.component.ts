    ...
    let estadoEntrevista: Array<any> = [];
      this.entrevistaService.get('estado_entrevista/?limit=0')
        .subscribe(res => {
          ...
          this.formEntrevista.campos[ this.getIndexForm('EstadoEntrevistaId') ].opciones = estadoEntrevista;
        });
  }
    ...
    let tipoEntrevista: Array<any> = [];
      this.entrevistaService.get('tipo_entrevista/?limit=0')
        .subscribe(res => {
          ...
          this.formEntrevista.campos[ this.getIndexForm('TipoEntrevistaId') ].opciones = tipoEntrevista;
        });
  }
