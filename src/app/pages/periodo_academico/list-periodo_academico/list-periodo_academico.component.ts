...
@Component({
  selector: 'ngx-list-periodo-academico',
  templateUrl: './list-periodo_academico.component.html',
  styleUrls: ['./list-periodo_academico.component.scss'],
  })
export class ListPeriodoAcademicoComponent implements OnInit {
  uid: number;
