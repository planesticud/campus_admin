...
@Component({
  selector: 'ngx-list-requisito-academico',
  templateUrl: './list-requisito_academico.component.html',
  styleUrls: ['./list-requisito_academico.component.scss'],
})
export class ListRequisitoAcademicoComponent implements OnInit {
  uid: number;
