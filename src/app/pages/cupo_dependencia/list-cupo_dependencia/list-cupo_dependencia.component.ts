...
@Component({
  selector: 'ngx-list-cupo-dependencia',
  templateUrl: './list-cupo_dependencia.component.html',
  styleUrls: ['./list-cupo_dependencia.component.scss'],
})
export class ListCupoDependenciaComponent implements OnInit {
  uid: number;
  ...
  cargarCampos() {
    this.settings = {
      ...
      columns: {
        ...
        CuposHabilitados: {
          title: this.translate.instant('GLOBAL.cupos_habilitados'),
          width: '15%',
          valuePrepareFunction: (value) => {
            return value;
          },
        ...
        CuposOpcionados: {
          title: this.translate.instant('GLOBAL.cupos_opcionados'),
          width: '15%',
          valuePrepareFunction: (value) => {
            return value;
          },
  ...
  loadData(): void {
    this.requisitoService.get('cupos_por_dependencia/?limit=0').subscribe(res => {
