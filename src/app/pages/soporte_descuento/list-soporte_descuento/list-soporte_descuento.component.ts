...
@Component({
  selector: 'ngx-list-soporte-descuento',
  templateUrl: './list-soporte_descuento.component.html',
  styleUrls: ['./list-soporte_descuento.component.scss'],
  })
export class ListSoporteDescuentoComponent implements OnInit {
  uid: number;
  ...
  loadData(): void {
    this.descuentosService.get('soporte_descuento/?limit=0').subscribe(res => {
      if (res !== null) {
                        ...
                        if (res4 != null) {
                          ...
                          this.descuentosService.get('tipo_descuento/' + dependenciaId.TipoDescuentoId.Id).subscribe(res5 => {
                            if (res5 !== null) {
                              ...
                              this.personas.get('persona/' + persona).subscribe(res6 => {
                                if (res6 !== null) {
                                  element.SolicitudDescuentoId.PersonaId = <any>res6;
  ...
  onDelete(event): void {
    ...
    .then((willDelete) => {
      if (willDelete.value) {
        this.descuentosService.delete('soporte_descuento/', event.data).subscribe(res => {
          if (res !== null) {
            this.loadData();
