...
@Component({
  selector: 'ngx-list-tipo-descuento',
  templateUrl: './list-tipo_descuento.component.html',
  styleUrls: ['./list-tipo_descuento.component.scss'],
})
export class ListTipoDescuentoComponent implements OnInit {
  uid: number;
