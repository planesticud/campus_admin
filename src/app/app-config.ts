...
export const Config = {
  LOCAL: {
    ...
    VALIDACION_OIKOS_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/dependencias_api/v1/',

    // VALIDACION_OIKOS_SERVICE: 'http://jbpm.udistritaloas.edu.co:8280/services/servicios_homologacion_dependencias/',
    // VALIDACION_OIKOS_SERVICE: 'https://autenticacion.udistrital.edu.co/apioas/snies/v1/', //linea para probar el otro servicio
    // #revisar
  ...
  PREPROD: {
    ...
    // TERCEROS_OAS: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/terceros_crud/v1/',
    WSO2_SERVICE: 'http://jbpm.udistritaloas.edu.co:8280/services',
    TOKEN: {
