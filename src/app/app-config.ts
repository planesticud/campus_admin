...
export const Config = {
  LOCAL: {
    ...
    MENU_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/configuracion/v1/menu_opcion_padre/ArbolMenus/',
    ...
    PROGRAMA_OIKOS_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/programa_ud/v1/',
    UBICACION_SERVICE: 'http://localhost:8085/v1/',
    VALIDACION_OIKOS_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/homologacion/v1/',
